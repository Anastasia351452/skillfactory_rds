   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "['.ipynb_checkpoints', 'data', 'data.csv', 'data_revenue.csv', 'data_revenue.xls', 'data_revenue_.xls', 'data_sf.xls', 'log.xls', 'Movies.ipynb', 'movies.xls', 'Pandas.ipynb', 'ratings.xls', 'sample.xls', 'sample_data_del_clomns.csv', 'sample_data_del_column_2.csv', 'users.xls', '[SF-DST] Movies IMBD v3.0.ipynb', 'Букмекерская контора.ipynb', 'Как разбить 1 колонку на несколько.ipynb', 'Код Мити локоничный.ipynb', 'Работа с csv.ipynb']\n"
     ]
    }
   ],
   "source": [
